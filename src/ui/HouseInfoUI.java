...
//                    btnPillage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Pillage_Disabled.PNG")));
        ...
        txtLevelWall.addKeyListener(new KeyAdapter() {
            public void keyReleased(KeyEvent evt) {
                ...
                if (IntVal < 0) {
                    txtLevelWall.setText("0");
                    // TODO(10): edit IntVal >=40 to 42 for check level of wall
                } else if (IntVal >= 42) {
        ...
        btnPillage.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                if (IsLandUI.myHouse == null) {
                    ...
                    // TODO(11): edit mouseClicked btnPillage when cbo do not select enemy
                } else if (cbo.getSelectedIndex() != 2) {
                    JOptionPane.showMessageDialog(null, "Chỉ có thể công nhà của địch!");
                } else {
                    setHouseInfo();
...
//            IsLandUI.currentHouse.getBattleField().resetAll(IsLandUI.currentHouse.getLevelOfHouse());
        ...
        if (type.equals("My House")) {
            ...
            IsLandUI.currentTextField.setText(" My House");
            IsLandUI.currentTextField.setVisible(true);
            btnPillage.setEnabled(false);
        } else if (type.equals("My Ally")) {
            IsLandUI.currentHouse.setTypeOfHouse(1);
            setIconHouse();
            IsLandUI.currentTextField.setText("  My Ally\n " + IsLandUI.currentHouse.getName());
            IsLandUI.currentTextField.setBounds(IsLandUI.currentTextField.getBounds().x, IsLandUI.currentTextField.getBounds().y,
                    IsLandUI.currentTextField.getBounds().width, 30);
            IsLandUI.currentTextField.setVisible(true);
            btnPillage.setEnabled(false);
        } else if (type.equals("Enemy")) {
            IsLandUI.currentHouse.setTypeOfHouse(2);
            setIconHouse();
            IsLandUI.currentTextField.setText("   Enemy\n " + IsLandUI.currentHouse.getName());
            IsLandUI.currentTextField.setBounds(IsLandUI.currentTextField.getBounds().x, IsLandUI.currentTextField.getBounds().y,
                    IsLandUI.currentTextField.getBounds().width, 30);
            IsLandUI.currentTextField.setVisible(true);
            btnPillage.setEnabled(true);
            ...
            IsLandUI.currentTextField.setVisible(false);
        }
//        IsLandUI.currentTextField.setText("   " + type + ":\n " + IsLandUI.currentHouse.getName());
//        IsLandUI.currentTextField.setVisible(true);
        this.dispose();
    }
