...
public class Army {
    ...
    public static enum Unit {
        Archer(2, ""), Balloon(1, ""), Catapult(2, ""), Gyrocopter(1, ""), Hoplite(1, ""),
        Mortar(1, ""), Ram(3, ""), Slinger(3, ""), Spearman(2, ""), SteamGiant(2, ""),
        Sulfur(1, ""), Swordsman(1, ""), Wall(0, "");
    ...
    public int getSpeedTimeForWholeRoute() {
        if (getNumberOfBB() > 0) {
            ...
            return 15 * 60 * 1000 / 3;
                ...
                || getNumberOfHop() > 0
                || getNumberOfSpear() > 0
                // TODO(8): add getNumberOfSword > 0 for whole route time
                || getNumberOfSword() > 0) {
            return 10 * 60 * 1000 / 3;
        }
        // TODO(7): change speed for whole route of Gyrocopter
        return 75 * 6 * 1000 / 3;
    }
}
