...
public class Slot {
    ...
    private float initHitpointUnit; // máu mỗi quân ban đầu.
    ...
    public float getInitHitpointUnit() {
        return initHitpointUnit;
    }

    public void setInitHitpointUnit(float initHitpointUnit) {
        this.initHitpointUnit = initHitpointUnit;
    }

    public float getTotalHitpoint() {
